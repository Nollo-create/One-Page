...
export const translations = {
  en: {
    ...
    hero: {
      ...
      est:    'Est. 2014',
      lines:  ['We craft', 'digital', 'experiences', 'that captivate.'],
    ...
    work: {
      ...
      projects: {
        dcosmetics:   { tagline: 'Premium beauty & skincare brand',          category: 'Brand Identity & Web' },
        deltoros:     { tagline: 'Steakhouse & grill — Tres Hermanos',       category: 'Restaurant Identity' },
        tonmaster:    { tagline: 'Audio production & sound mastering',       category: 'Brand & Web' },
        tanjarajkovic:{ tagline: 'Personal portfolio',                       category: 'Personal Brand' },
        viz:          { tagline: 'Streetwear & lifestyle',                   category: 'Brand Identity' },
      },
    },
    services: {
      label:   'What We Do',
      heading: ['Full-spectrum', 'digital craft'],
    ...
    about: {
      ...
      heading: ['Small studio.', 'Big ambition.'],
      ...
      stats: [
        { display: '2014', label: 'Year founded' },
    ...
    process: {
      ...
      steps: [
        { number: '01', title: 'Discovery',      duration: '1–2 weeks',  desc: 'We start by understanding your business, your audience, and your goals. Through structured workshops and conversations, we map the full landscape before touching a single pixel.' },
        { number: '02', title: 'Strategy',       duration: '1 week',     desc: 'We define the direction: information architecture, user flows, content strategy, and the core positioning that will guide every design decision that follows.' },
        { number: '03', title: 'Design',         duration: '2–4 weeks',  desc: 'Visual concepts that align with your brand and speak directly to your users. We iterate quickly, present clearly, and refine until every detail is exactly right.' },
        { number: '04', title: 'Development',    duration: '2–6 weeks',  desc: 'We translate designs into fast, accessible, responsive code. Every interaction is crafted with care. We test across devices and browsers before a single line goes live.' },
        { number: '05', title: 'Launch & Grow',  duration: 'Ongoing',    desc: 'We don’t just deliver and disappear. We support your launch, monitor performance, and remain a strategic partner as your business evolves.' },
      ],
    },
    testimonials: {
      ...
      items: [
        { quote: 'Working with SAJTPRESS was completely different from any agency we’d worked with before. They understood our brand immediately and pushed us in directions we hadn’t considered — every one of which was right.', author: 'Sarah Chen',   role: 'CEO, Portakal Wines',            initials: 'SC', rating: 5 },
        { quote: 'The website they built increased our lead conversion by 40%. But beyond the numbers, it just feels right. Every interaction, every transition — it communicates exactly who Meridian is.',                                       author: 'Marcus Reid', role: 'Founder, Meridian Capital',      initials: 'MR', rating: 5 },
        { quote: 'SAJTPRESS doesn’t just execute a brief — they think with you. Our e-commerce site went from generic to genuinely beautiful, and sales reflect that shift immediately.',                                                      author: 'Yuki Tanaka', role: 'Creative Director, Hana Studio', initials: 'YT', rating: 5 },
      ],
    },
    contact: {
      label:   'Get in Touch',
  ...
  sr: {
    ...
    hero: {
      ...
      est:    'Osnovano 2014.',
      lines:  ['Kreiramo', 'digitalna', 'iskustva', 'koja oduševljavaju.'],
      ...
      stats: [
        ...
        { value: 150, suffix: '+', label: 'Završenih projekata' },
        { value: 98,  suffix: '%', label: 'Zadovoljnih klijenata' },
      ],
      scroll: 'Skroluj',
    },
    marquee: [
    ...
    work: {
      ...
      projects: {
        dcosmetics:   { tagline: 'Premium brend za kozmetiku i negu kože',     category: 'Brend identitet i web' },
        deltoros:     { tagline: 'Restoran i roštilj — Tres Hermanos',         category: 'Restoranski identitet' },
        tonmaster:    { tagline: 'Audio produkcija i mastering zvuka',         category: 'Brend i web' },
        tanjarajkovic:{ tagline: 'Lični portfolio',                            category: 'Lični brend' },
        viz:          { tagline: 'Streetwear i lifestyle',                     category: 'Brend identitet' },
      },
    },
    services: {
      label:   'Šta radimo',
      heading: ['Pun spektar', 'digitalnog zanata'],
      ...
      items: [
        {
          ...
          tags:   ['UI dizajn', 'Responzivnost', 'Prototipiranje'],
        },
        {
          number: '02',
          title:  'Web razvoj',
        ...
        },
        {
          ...
          tags:   ['Istraživanje', 'Tokovi', 'Testiranje'],
        },
        {
          number: '04',
          ...
          tags:   ['Logo', 'Smernice', 'Vizuelni identitet'],
        },
      ],
    },
    about: {
      label:   'O Sajtpress-u',
      heading: ['Mali studio.', 'Velika ambicija.'],
      ...
      stats: [
        { display: '2014', label: 'Godina osnivanja' },
        { value: 8,        label: 'Članova tima' },
        { value: 14,       label: 'Nagrada u industriji' },
      ],
      visual: {
    ...
    process: {
      label:   'Kako radimo',
      heading: ['Proces napravljen', 'za rezultate'],
      desc:    'Transparentno, kroz saradnju i predvidivo. Uvek ćete znati gde smo i šta sledi.',
      steps: [
        { number: '01', title: 'Otkrivanje',          duration: '1–2 nedelje',  desc: 'Počinjemo razumevanjem vašeg biznisa, publike i ciljeva. Kroz strukturirane radionice i razgovore, mapiramo ceo pejzaž pre nego što dotaknemo nijedan piksel.' },
        { number: '02', title: 'Strategija',          duration: '1 nedelja',    desc: 'Definišemo pravac: arhitekturu informacija, korisničke tokove, strategiju sadržaja i osnovno pozicioniranje koje će voditi svaku dizajnersku odluku koja sledi.' },
        { number: '03', title: 'Dizajn',              duration: '2–4 nedelje',  desc: 'Vizuelni koncepti koji su u skladu sa vašim brendom i govore direktno vašim korisnicima. Iteriramo brzo, prezentujemo jasno i finalizujemo dok svaki detalj nije tačno na svom mestu.' },
        { number: '04', title: 'Razvoj',              duration: '2–6 nedelja',  desc: 'Prevodimo dizajn u brz, pristupačan i responzivan kod. Svaka interakcija je rađena sa pažnjom. Testiramo na različitim uređajima i pretraživačima pre nego što ijedna linija ode uživo.' },
        { number: '05', title: 'Lansiranje i rast',   duration: 'Kontinuirano', desc: 'Ne isporučujemo i nestajemo. Podržavamo vaše lansiranje, pratimo performanse i ostajemo strateški partner kako vaš biznis raste.' },
      ],
    },
    testimonials: {
      ...
      items: [
        { quote: 'Rad sa SAJTPRESS-om je bio potpuno drugačiji od bilo koje agencije sa kojom smo do tada sarađivali. Razumeli su naš brend trenutno i gurali nas u pravce o kojima nismo razmišljali — svaki od njih je bio ispravan.', author: 'Sarah Chen',   role: 'CEO, Portakal Wines',                  initials: 'SC', rating: 5 },
        { quote: 'Sajt koji su izgradili povećao je našu stopu konverzije za 40%. Ali van brojeva, jednostavno se ispravno oseća. Svaka interakcija, svaka tranzicija — komuniciraju tačno ono što Meridian jeste.',                              author: 'Marcus Reid', role: 'Osnivač, Meridian Capital',            initials: 'MR', rating: 5 },
        { quote: 'SAJTPRESS ne samo da izvršava brief — oni razmišljaju sa vama. Naš e-commerce sajt je iz generičnog prešao u istinski lep, a prodaja to odmah odražava.',                                                                       author: 'Yuki Tanaka', role: 'Kreativna direktorka, Hana Studio',    initials: 'YT', rating: 5 },
      ],
    },
    contact: {
      label:   'Kontakt',
      heading: ['Spremni da napravimo', 'nešto sjajno?'],
